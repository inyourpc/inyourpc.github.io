var gameState = {
	...
	create: function() {
		...
		this.moneyTitleInput =  game.add.inputField(100, 370, {
			font: '36px Arial',
			fill: '#000000',
			...
			borderWidth: 1,
			borderColor: '#000000',
			placeHolder: 'THE MONEY MAMMALS',
			//zoom: true
        });
        
       
        document.getElementById(""+	this.moneyTitleInput.domElement.id).addEventListener("change", function(){
